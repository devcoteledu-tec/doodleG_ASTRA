...
Start with **MANUAL_UPGRADE.md** when applying this release to the uploaded project. **PROJECT_REVIEW.md** describes the review, remaining risks and score. **DEPLOYMENT.md** covers production operations.
